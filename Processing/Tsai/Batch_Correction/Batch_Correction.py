...
#this caused an error so removed for now: adata.obsm["X_normalized_scVI"] = vae.get_normalized_expression() #store normalized matrix (this is the decoded matrix, should in theory be the same as the one that was input
