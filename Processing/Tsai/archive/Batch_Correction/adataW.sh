...
#SBATCH --mem=850G              # GB memory needed (memory PER CORE)
...
# conda activate  /orcd/data/lhtsai/001/om2/mabdel03/conda_envs/Annotations_SingleCell

# Rscript anno.Rscript
python3 adataWork.py