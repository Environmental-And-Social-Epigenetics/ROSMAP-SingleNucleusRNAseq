...
preflight_env_specs() {
    ...
    local env_dirs=(
        "${REPO_ROOT}/envs/preprocessing/cellbender"
        "${REPO_ROOT}/envs/preprocessing/synapse"
        "${REPO_ROOT}/envs/preprocessing/bcftools"
        "${REPO_ROOT}/envs/preprocessing/globus"
        "${REPO_ROOT}/envs/processing/stage1_qc"
        "${REPO_ROOT}/envs/processing/stage2_doublets"
        "${REPO_ROOT}/envs/processing/stage3_integration"
        "${REPO_ROOT}/envs/analysis/deg"
        "${REPO_ROOT}/envs/analysis/nebula"
        "${REPO_ROOT}/envs/analysis/sccomp"
        "${REPO_ROOT}/envs/analysis/scenic"
        "${REPO_ROOT}/envs/analysis/compass"
        "${REPO_ROOT}/envs/analysis/gsea"
    )
