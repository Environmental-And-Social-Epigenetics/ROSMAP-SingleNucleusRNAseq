#!/bin/bash
# =============================================================================
# slurm_upload.sh — SLURM array job wrapper for DeJager NAS upload
# =============================================================================
# Submit with:
...
#SBATCH --job-name=nas_upload_dejager
#SBATCH --array=0-19
#SBATCH --time=2-00:00:00
#SBATCH --mem=2G
#SBATCH --cpus-per-task=1
#SBATCH --output=/home/%u/nas_upload_dejager_%A_%a.out
#SBATCH --error=/home/%u/nas_upload_dejager_%A_%a.err
