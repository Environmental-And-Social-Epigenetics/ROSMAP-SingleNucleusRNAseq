...
echo "y" | compass --data matrix500_male_Ast.tsv --num-processes 40 --species homo_sapiens --output-dir CompassPMAstNew

echo "y" | compass --data matrix500_female_Ast.tsv --num-processes 40 --species homo_sapiens --output-dir CompassPFAstNew