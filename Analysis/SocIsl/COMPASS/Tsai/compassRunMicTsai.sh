...
echo "y" | compass --data matrix500_male_Mic.tsv --num-processes 40 --species homo_sapiens --output-dir CompassPMMicNew

echo "y" | compass --data matrix500_female_Mic.tsv --num-processes 40 --species homo_sapiens --output-dir CompassPFMicNew