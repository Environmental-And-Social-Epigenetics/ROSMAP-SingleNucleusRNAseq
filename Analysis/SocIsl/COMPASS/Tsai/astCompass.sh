...
echo "y" | compass --data carlesmale_matrixAst.tsv --num-processes 40 --species homo_sapiens --output-dir CompassPMAstHere

echo "y" | compass --data carlesfemale_matrixAst.tsv --num-processes 40 --species homo_sapiens --output-dir CompassPFAstHere