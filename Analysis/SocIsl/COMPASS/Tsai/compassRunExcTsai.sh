...
echo "y" | compass --data matrix500_male_Exc.tsv --num-processes 40 --species homo_sapiens --output-dir CompassPMExcNew

echo "y" | compass --data matrix500_female_Exc.tsv --num-processes 40 --species homo_sapiens --output-dir CompassPFExcNew