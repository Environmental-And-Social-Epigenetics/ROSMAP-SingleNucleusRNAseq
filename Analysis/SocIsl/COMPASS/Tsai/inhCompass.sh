...
# echo "y" | compass --data carlesmale_matrixInh.tsv --num-processes 40 --species homo_sapiens --output-dir CompassPMInhHere

echo "y" | compass --data carlesfemale_matrixInh.tsv --num-processes 40 --species homo_sapiens --output-dir CompassPFInhHere