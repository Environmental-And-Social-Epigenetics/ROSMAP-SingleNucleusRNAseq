...
echo "y" | compass --data dejpseudobulk_male_Exc.tsv --num-processes 10 --species homo_sapiens --output-dir CompassPMExc

echo "y" | compass --data dejpseudobulk_female_Exc.tsv --num-processes 10 --species homo_sapiens --output-dir CompassPFExc