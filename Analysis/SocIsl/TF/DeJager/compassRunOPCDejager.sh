...
echo "y" | compass --data dejpseudobulk_male_Opc.tsv --num-processes 10 --species homo_sapiens --output-dir CompassPMOPC

echo "y" | compass --data dejpseudobulk_female_Opc.tsv --num-processes 10 --species homo_sapiens --output-dir CompassPFOPC