...
echo "y" | compass --data pseudobulk_male_Ast.tsv --num-processes 10 --species homo_sapiens --output-dir CompassPMAst

echo "y" | compass --data pseudobulk_female_Ast.tsv --num-processes 10 --species homo_sapiens --output-dir CompassPFAst