...
echo "y" | compass --data dejpseudobulk_male_Ast.tsv --num-processes 10 --species homo_sapiens --output-dir CompassPMAst

echo "y" | compass --data dejpseudobulk_female_Ast.tsv --num-processes 10 --species homo_sapiens --output-dir CompassPFAst