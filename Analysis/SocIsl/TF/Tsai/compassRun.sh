...
echo "y" | compass --data matrixOPC.tsv --num-processes 10 --species homo_sapiens --output-dir OPCCompass
echo "y" | compass --data matrixOli.tsv --num-processes 10 --species homo_sapiens --output-dir OliCompass