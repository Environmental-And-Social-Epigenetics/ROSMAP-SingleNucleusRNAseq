...
echo "y" | compass --data carlesmale_matrixMic.tsv --num-processes 40 --species homo_sapiens --output-dir CompassPMMicHere

# echo "y" | compass --data carlesfemale_matrixMic.tsv --num-processes 40 --species homo_sapiens --output-dir CompassPFMicHere