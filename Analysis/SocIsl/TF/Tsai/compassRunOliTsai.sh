...
echo "y" | compass --data matrix500_male_Oli.tsv --num-processes 40 --species homo_sapiens --output-dir CompassPMOliNew

echo "y" | compass --data matrix500_female_Oli.tsv --num-processes 40 --species homo_sapiens --output-dir CompassPFOliNew