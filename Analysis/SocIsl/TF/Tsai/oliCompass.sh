...
# echo "y" | compass --data carlesmale_matrixOli.tsv --num-processes 40 --species homo_sapiens --output-dir CompassPMOliHere

echo "y" | compass --data carlesfemale_matrixOli.tsv --num-processes 40 --species homo_sapiens --output-dir CompassPFOliHere