...
echo "y" | compass --data carlesmale_matrixOPC.tsv --num-processes 40 --species homo_sapiens --output-dir CompassPMOPCHere

echo "y" | compass --data carlesfemale_matrixOPC.tsv --num-processes 40 --species homo_sapiens --output-dir CompassPFOPCHere