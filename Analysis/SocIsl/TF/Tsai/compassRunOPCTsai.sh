#!/bin/bash
#SBATCH -n 60                  	 # Number of cores requested
...
echo "y" | compass --data matrix500_male_OPC.tsv --num-processes 60 --species homo_sapiens --output-dir CompassPMOPCNew

echo "y" | compass --data matrix500_female_OPC.tsv --num-processes 60 --species homo_sapiens --output-dir CompassPFOPCNew