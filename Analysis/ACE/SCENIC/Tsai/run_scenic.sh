...
# ---------------------------------------------------------------------------
# Arguments (passed by aceScenicT.sh or manually)
# ---------------------------------------------------------------------------
...
OUTPUT_DIR="${ACE_OUTPUT_ROOT}/SCENIC/Tsai/results_${INTEGRATION}/${PHENOTYPE}/${SEX}_${CELL_TYPE}"
mkdir -p "${OUTPUT_DIR}"
