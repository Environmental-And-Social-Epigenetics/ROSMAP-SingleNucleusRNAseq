#!/bin/bash
# Submit the ACE sccomp workflow for the DeJager cohort.
...
echo "=== ACE Cell Type Proportion Pipeline: DeJager ==="
...
for INTEGRATION in "${INTEGRATIONS[@]}"; do
    ...
    PREP_JOB=$(sbatch --parsable \
        ...
        --job-name="acepropDJ_prep_${INTEGRATION}" \
    ...
    for SEX in "${SEX_STRATA[@]}"; do
        for RESOLUTION in "${RESOLUTIONS[@]}"; do
            SCCOMP_JOB=$(sbatch --parsable \
                ...
                --job-name="acepropDJ_${INTEGRATION}_${SEX}_${RESOLUTION}" \
    ...
    VIZ_JOB=$(sbatch --parsable \
        ...
        --job-name="acepropDJ_viz_${INTEGRATION}" \
