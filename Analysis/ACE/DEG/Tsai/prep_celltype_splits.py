#!/usr/bin/env python3
"""
Prepare per-cell-type raw-count H5AD files for Tsai ACE pseudobulk DEG.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Prepare per-cell-type Tsai ACE H5AD files.")
