...
#SBATCH --mem=64G
#SBATCH -t 04:00:00
#SBATCH -o %j_PVBasket_LowAD_Male.out
#SBATCH -e %j_PVBasket_LowAD_Male.err
...
RESULTS_DIR="${OUTPUT_ROOT}/results_${INTEGRATION}_PVBasket_LowAD_Male/${PHENOTYPE}"
mkdir -p "${RESULTS_DIR}"

echo "Integration:   ${INTEGRATION}"
echo "Phenotype:     ${PHENOTYPE}"
echo "Cell type:     In-PV_Basket"
echo "Filter:        msex==1, niareagansc in {3,4}"
echo "Input dir:     ${INPUT_DIR}"
echo "Output dir:    ${RESULTS_DIR}"
echo "Smoke flag:    ${SMOKE_FLAG:-(none)}"

CMD=(
  Rscript "${SCRIPT_DIR}/aceDegT_PVBasket_LowAD_Male.Rscript"
